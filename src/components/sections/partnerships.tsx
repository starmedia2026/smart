 ...
 * تم تحديثه ليشمل الشعارات التسعة الجديدة ويدعم الوضع الداكن.
 */
      ...
      <div className="container mx-auto px-6 mb-16">
        <div className="flex items-center justify-center gap-6">
          ...
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold font-headline text-foreground dark:text-white flex items-center justify-center gap-4">
              <span className="w-2 h-2 rounded-full bg-primary animate-pulse ml-2" />
              شركاء النجاح
              <span className="w-2 h-2 rounded-full bg-primary animate-pulse mr-2" />
            </h2>

            <p className="text-sm md:text-base text-foreground/60 dark:text-white/60 mt-3">
