      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            في نمو للبرمجيات، نؤمن بأن كل شركة تستحق أن تكون في القمة. رحلتنا بدأت بشغف تحويل التحديات المعقدة إلى واجهات بسيطة وحلول فعالة تضع عملاءنا في طليعة المنافسة.
          </p>
        </div>
