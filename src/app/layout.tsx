  ...
  return (
    <html lang="ar" dir="rtl" className="dark">
      <head>
        ...
        {/* Favicons */}
        <link rel="icon" href="https://i.postimg.cc/Y0KRySPt/Untitled-1.jpg" />
        <link rel="icon" type="image/png" sizes="32x32" href="https://i.postimg.cc/Y0KRySPt/Untitled-1.jpg" />
        <link rel="icon" type="image/png" sizes="16x16" href="https://i.postimg.cc/Y0KRySPt/Untitled-1.jpg" />
        <link rel="apple-touch-icon" sizes="180x180" href="https://i.postimg.cc/Y0KRySPt/Untitled-1.jpg" />
      </head>
