  ...
  return (
    <html lang="ar" dir="rtl" className="dark">
      <head>
        ...
        {/* Favicons */}
        <link rel="icon" href="https://i.postimg.cc/t41FxxDT/IMG-20260318-WA0005(1).jpg" />
        <link rel="icon" type="image/png" sizes="32x32" href="https://i.postimg.cc/t41FxxDT/IMG-20260318-WA0005(1).jpg" />
        <link rel="icon" type="image/png" sizes="16x16" href="https://i.postimg.cc/t41FxxDT/IMG-20260318-WA0005(1).jpg" />
